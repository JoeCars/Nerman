...
const {
   shortenAddress,
} = require('../../../../../helpers/nouns/shortenAddress');
...
module.exports = {
   subCommand: 'trigger-nouns-auction-house.auction-end',
   ...
   async execute(interaction) {
      ...
      Logger.info(
         'commands/trigger-nouns-auction-house.auction-end.js: Event triggered.',
         {
