...
module.exports = {
   data: new SlashCommandBuilder()
      .setName('trigger-nouns-fork-tokens')
      .setDescription('Trigger a Nouns Fork Tokens event.')
   ...
   async execute() {
      Logger.info(
         'commands/trigger-nouns-fork-tokens.js: Executed Nerman trigger command.',
      );
   },
};
